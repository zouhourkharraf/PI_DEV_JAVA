...
public class AjouterEnseignantController implements Initializable {
    ...
    @FXML
    private Button bouton_ajouter_enseignant;
    @FXML
    private Button bouton_annuler_enseignant;
    @FXML
    ...
    private void AjouterEnseignant(ActionEvent event) {
        ...
        valid=false;
          ...
          // si le formulaire est validé on va ajouter l'enseignant
          if(valid)
          {
             ...
             Utilisateur utilisateur1=new Utilisateur(age1,champ_nom.getText(),champ_prenom.getText(),"",champ_mp.getText(),champ_email.getText(),genre1,"enseignant","non"); //création de l'objet utilisateur sans pseudo
              ...
              {     
                 ...
                 util_service.modifier_utilisateur(utilisateur2);
                        ...
                        alert.setTitle("Magic Book | Création d'un compte enseignant");
    ...
    @FXML
    private void AnnulerEnseignant(ActionEvent event) {
             champ_nom.clear();
        champ_prenom.clear();
        champ_age.clear();
        champ_email.clear();
